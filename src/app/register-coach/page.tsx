...
import { Loader2, UserPlus, Lightbulb, CheckCircle2, UploadCloud, Link as LinkIcon } from 'lucide-react';
...
import { debounce } from 'lodash'; // Assuming lodash is available or can be added
      ...
      <Card className="shadow-xl">
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="socialLinkPlatform">Social Media (Optional)</Label>
