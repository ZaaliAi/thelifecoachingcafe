...
export function generateMetadata({ searchParams }: { searchParams?: { search?: string } }): Metadata {
  ...
  const baseDescription = "Find and connect with life coaches in our comprehensive online directory. Search by specialty, name, or keyword to start your personal development journey.";
  ...
  return (
    <div className="space-y-12">
      <section className="text-center py-8">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Life Coach Directory: Find Coaches Online</h1>
        <p className="text-lg text-muted-foreground max-w-xl mx-auto">
          Explore our online life coach directory of talented and life coaches. Use the search below to find a coach based on your specific needs for personal development, career change, or mental wellness.
        </p>
      </section>
