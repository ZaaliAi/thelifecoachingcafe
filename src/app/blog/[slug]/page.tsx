...
import { mockBlogPosts, mockCoaches } from '@/data/mock';
...
// This would be a server component fetching a single post in a real app
...
export default async function BlogPostPage({ params }: { params: { slug: string } }) {
  ...
  const author = mockCoaches.find(coach => coach.id === post.authorId);
...
export async function generateStaticParams() {
  // In a real app, fetch all published post slugs
