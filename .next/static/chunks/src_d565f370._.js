...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/auth.tsx [app-client] (ecmascript)"); // This will use your src/lib/auth.tsx
...
function LoginPage() {
    ...
    const { user, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])(); // user from useAuth() should have role if auth.tsx works
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            ...
            if (user) {
                ...
                console.log(`[LoginPage] User details from context: email=${user.email}, uid=${user.id || user.uid}, role=${user.role}, name=${user.name}`);
            }
            if (!authLoading && user) {
                const redirectUser = {
                    "LoginPage.useEffect.redirectUser": ()=>{
                        // The 'user' from useAuth() should already have the role if auth.tsx is working as the previous logs suggest.
                        let determinedRole = user.role || 'user'; // Access role directly from the user object from context
                        // Override for admin email if necessary, as a safeguard or primary check
                        if (user.email === 'hello@thelifecoachingcafe.com') {
                            determinedRole = 'admin';
                            console.log(`[LoginPage] Role overridden to 'admin' for ${user.email}`);
                        }
                        console.log(`[LoginPage] Conditions met for redirect. User: ${user.email}, Determined Role: ${determinedRole}`);
                        ...
                        try {
                            ...
                            toast({
                                ...
                                description: "Could not redirect you automatically.",
                                variant: "destructive"
                            });
                        }
                    }
    ...
    const onSubmit = async (data)=>{
        setIsLoading(true);
        try {
            const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$683d5879$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ac__as__signInWithEmailAndPassword$3e$__["signInWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], data.email, data.password);
    ...
    if (authLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex items-center justify-center py-12 min-h-[calc(100vh-200px)]",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                            children: "Log in to access your The Life Coaching Cafe account."
                        }, void 0, false, {
                            fileName: "[project]/src/app/login/page.tsx",
                            lineNumber: 137,
                            columnNumber: 11
...
_s(LoginPage, "t8XDbTwHrrxHOQkzxwrLLYSOgkg=", false, function() {
    return [
...
//# sourceMappingURL=src_d565f370._.js.map